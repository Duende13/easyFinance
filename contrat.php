...
if(isset($_GET['id']) && !empty($_GET['id'])){
	$id = $_GET['id'];
	$selectFactureSortante = mysqli_query($db,"SELECT * FROM `contrats` LEFT JOIN `clients` ON `contrats`.`id_client`=`clients`.`id_client` WHERE `id`='$id'") or trigger_error(mysqli_error($db),E_USER_ERROR);
} else {
	header("location:./");
}
